...
| profile | mode 占比 | dirty-EoR power 占比 |
| --- | ---: | ---: |
| 逐模式 0.2h 矩形 floor | 57.1429% | 10.6607% |
| 有限 patch wedge + 0.2h floor + 0.10h buffer | 8.7588% | 10.6520% |
| 上式再交 30--2500 lambda | 8.7533% | 10.0647% |
| horizon wedge + floor + buffer | 0.02556% | 1.6756% |
| 上式再交 30--2500 lambda | 0.02000% | 1.0883% |
...
- 整 bin estimator 使用 `all_modes` 时必须单独报告 partial bins；更好的方案是增加频率
  数或重新设计与物理边界对齐的 bins。
